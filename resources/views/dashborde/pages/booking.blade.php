                    ...
                    <tbody>
                        @foreach($datas as $data)
                            <tr>
                                ...
                                <td class="text-wrap">{{$data->check_in}}</td>
                                <td class="text-wrap">{{$data->check_out}}</td>
                                ...
                                <td> <a  class="btn btn-gradient-danger btn-sm action-btn"  href="{{route('delete_booking', $data->id)}}" ><i class="mdi mdi-trash-can"></i></a></td>
                                <td> 
                                    <a class="btn btn-gradient-success btn-sm action-btn" href="{{url('approve_book' , $data->id)}}"><i class="fa-solid fa-check"></i></a>
                                    <a class="btn btn-gradient-danger btn-sm action-btn" href="{{url('Rejected_book' , $data->id)}}"><i class="fa-solid fa-xmark"></i></a>
                                </td>
                            </tr>
