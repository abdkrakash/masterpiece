                    ...
                    <tbody>
                        @foreach($datas as $data)
                            <tr>
                               ...
                               <td> <a  class="btn btn-gradient-danger btn-sm action-btn"  href="{{url('room_delete', $data->id)}}" ><i class="mdi mdi-trash-can"></i></a>
                                <a class="btn btn-gradient-primary btn-sm action-btn"  href="{{url('room_update', $data->id)}}" >                                <i class="mdi mdi-pencil"></i>
                                </a></td>
                            </tr>
                        @endforeach
                    </tbody>
